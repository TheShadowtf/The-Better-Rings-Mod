...
public class InvisibilityRing extends BTTRItem implements IItem {

	public InvisibilityRing(String name){
		this.setCreativeTab(BetterRingsCore.BetterRingsTab);
		this.setUnlocalizedName("invisibility_ring");
	...
	public void onUpdate(final ItemStack itemStack, final World world, final Entity entity, final int i, final boolean b) {
        ...
        if (entity instanceof EntityLivingBase) {
            ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.invisibility.id, 10, 0));
        }
    }
	...
	public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List,
			final boolean par4) {
		par3List.add(("" + StatCollector.translateToLocal("Give to player invisibility I.").trim()));
	...
	public String getUnlocalizedName(ItemStack itemstack) {
		...
		case 0:
			return "bttrm.invisibility_ring";
		}
