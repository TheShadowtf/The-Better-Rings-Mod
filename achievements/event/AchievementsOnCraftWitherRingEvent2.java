...
public class AchievementsOnCraftWitherRingEvent2 {

	@SubscribeEvent
	public void onCraftRing(PlayerEvent.ItemCraftedEvent e) {
		if(e.crafting.getItem().equals(ModItems.wither_ring_2)) {
			e.player.addStat(ModAchievements.achievementCraftWitherRing2, 1);
		}
	}
