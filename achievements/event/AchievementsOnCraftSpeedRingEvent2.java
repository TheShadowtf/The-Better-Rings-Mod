...
public class AchievementsOnCraftSpeedRingEvent2 {

	@SubscribeEvent
	public void onCraftRing(PlayerEvent.ItemCraftedEvent e) {
		if(e.crafting.getItem().equals(ModItems.speed_ring_2)) {
			e.player.addStat(ModAchievements.achievementCraftSpeedRing2, 1);
		}
	}
