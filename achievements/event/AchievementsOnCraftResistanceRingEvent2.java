...
public class AchievementsOnCraftResistanceRingEvent2 {

	@SubscribeEvent
	public void onCraftRing(PlayerEvent.ItemCraftedEvent e) {
		if(e.crafting.getItem().equals(ModItems.resistance_ring_2)) {
			e.player.addStat(ModAchievements.achievementCraftResistanceRing2, 1);
		}
	}
