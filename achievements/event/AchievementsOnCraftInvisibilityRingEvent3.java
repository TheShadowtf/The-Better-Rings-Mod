...
public class AchievementsOnCraftInvisibilityRingEvent3 {

	@SubscribeEvent
	public void onCraftRing(PlayerEvent.ItemCraftedEvent e) {
		if(e.crafting.getItem().equals(ModItems.invisibility_ring_3)) {
			e.player.addStat(ModAchievements.achievementCraftInvisibilityRing3, 1);
		}
	}
