...
public class AchievementsOnCraftRegenerationRingEvent2 {

	@SubscribeEvent
	public void onCraftRing(PlayerEvent.ItemCraftedEvent e) {
		if(e.crafting.getItem().equals(ModItems.regeneration_ring_2)) {
			e.player.addStat(ModAchievements.achievementCraftRegenerationRing2, 1);
		}
	}
